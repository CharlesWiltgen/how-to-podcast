...
<img src="iTunes-MP3-Encoder-Settings-96-JS.png" style="width:60%;display:block;margin: 0 auto">

To set these MP3 Encoder preferences, go to **Preferences** and click the **Import Settings** button in the **General** tab.

Once your encoding preferences are set, select your uncompressed source file and choose **File** > **Create New Version** > **Create MP3 Version** to encode your episode as an MP3 file. (In older versions of iTunes, you can right-click the selected source file instead.)
